...
DevFlow AI is an agentic AI-powered web application that automates real-world workflows such as data cleaning, email generation, and intelligent task execution.

Built for the **CodePup HackFest**.

[Demo Video: https://vimeo.com/1177828431?share=copy&fl=sv&fe=ci]

[Try it Live: http://devflow-ai.s3-website-us-east-1.amazonaws.com]
...
*  **Natural Language to Visual Workflow:** Instantly breaks a user's prompt down into a highly readable, interactive node-based flowchart.
...
* **Deployment:** Amazon web service(AWS) S3
